...
HD_PWD='E:/School/SP2023/CMPEN 371/final_project/final_project/final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fixed_16_16_multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fixed_16_16_multiplier.tcl -notrace
