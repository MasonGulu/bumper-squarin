...
HD_PWD='E:/School/SP2023/CMPEN 371/final_project/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fixed_16_16_multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fixed_16_16_multiplier.tcl
